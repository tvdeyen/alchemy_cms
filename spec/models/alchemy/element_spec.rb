...
module Alchemy
  describe Element do
    ...
    describe '#cache_key' do
      let(:page) { create(:alchemy_page, :public, published_at: Time.current - 1.week) }
      let(:element) { create(:alchemy_element, page_version: page.public_version, updated_at: Time.current) }

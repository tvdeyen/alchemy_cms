  ...
  describe Api::PagesController do
    ...
    describe "#show" do
      context "for existing page" do
        let(:page) { create(:alchemy_page, :public, url_path: "a-page") }

        it "returns page as json" do
          get :show, params: { url_path: page.url_path, format: :json }
        ...
        context "requesting an restricted page" do
          let(:page) { create(:alchemy_page, restricted: true, url_path: "a-page") }
        ...
        context "requesting a not public page" do
          let(:page) { create(:alchemy_page, url_path: "a-page") }
      ...
      context "requesting an unknown page" do
        it "responds with 404" do
          get :show, params: { url_path: "not-existing", format: :json }
        ...
        context "because of requesting not existing language" do
          ...
          it "responds with 404" do
            get :show, params: { url_path: page.url_path, locale: "na", format: :json }
            expect(response.status).to eq(404)
          end
        end
      end
      ...
      context "requesting a page with id" do
        ...
        it "responds with json" do
          get :show, params: { url_path: page.id, format: :json }
        ...
        context "having two pages with the same url names in different languages" do
          ...
          context "when a locale is given" do
            it "renders the page related to its language" do
              get :show, params: { url_path: "same-name", locale: klingon_page.language_code, format: :json }
              result = JSON.parse(response.body)
          ...
          context "when no locale is given" do
            it "renders the page of the default language" do
              get :show, params: { url_path: "same-name", format: :json }
              result = JSON.parse(response.body)
